  ...
  Scanner sc = new Scanner(System.in);
   ...
   int[] ass = new int [7];
      ...
      int get_stu()
      {
        ...
        name=sc.next();    out.println("");
        out.print("Enter ID : ");
        ID=sc.nextInt();    out.println("");
        out.print("Enter Roll Number : ");
        rolls=sc.nextInt();    out.println("");
        out.print("Enter 1 Subject : ");
        sub1=sc.next();    out.println("");
...
out.println("------------------------------------------------------------------------------------------------------------------------");
    ...
    String sub_1(){return sub1;}
     String sub_2(){return sub2;}
...
for(i=0;i<2;i++)
{
  ...
  do{ out.println("---------------------------------------------------School Database 1.0--------------------------------------------------");
                                          ...
                                          out.println("Press 2. To show all Data");
                                            ...
                                            switch(op2)
                                            {
                                                case 1: out.println("------------------------------------------------------------------------------------------------------------------------");
                                                 ...
                                                 for(i=0;i<2;i++)
                                                {
                                                    if(stud[i].ID==0){out.println(flag=1);break;}
                              ...
                              switch(op1)
                              {
                                case 1: out.println("------------------------------------------------------------------------------------------------------------------------");
                                    ...
                                    break;
                                        ...
                                        for(i=0;i<2;i++)
                                                {
                                                    if(stud[i].ID==0){out.println("Enter the data first.");break;}
                                                    else{
